    ...
    <AnimatePage>
      <Container size={"xl"} py="xl">
        ...
        <ResponsiveText mt={20}>
          ...
          in full-stack development — building seamless user interfaces and
          robust backend systems.
        </ResponsiveText>

        <ResponsiveText mt="md">
          Beyond code, I bring empathy, self-awareness, and a thoughtful
          approach to everything I create. My journey has taught me the value of
          emotional growth, personal responsibility, and designing software that
          truly helps people. I believe great software isn&apos;t just
          functional — it&apos;s human at its core.
        </ResponsiveText>
        ...
        <ResponsiveText mt="lg">
          ...
          <strong>Redux</strong>, <strong>Tailwind</strong>,{" "}
          <strong>MUI</strong>, <strong>Mantine</strong>, and{" "}
