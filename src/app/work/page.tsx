    ...
    <Container size="md" py="xl">
      ...
      <Timeline active={0} bulletSize={24} lineWidth={2}>
        ...
        <Timeline.Item title="Frontend Developer – Increasingly">
          ...
          <Text size="sm" mt={4}>
            Integrated AI-powered product bundling features into e-commerce
            platforms for brands like Samsung, Motorola, and Avon. Collaborated
            closely with global clients to deliver high-performance custom UIs.
          </Text>
        </Timeline.Item>
        ...
        <Timeline.Item title="Freelance Developer – Athayog Living">
          ...
          <Text size="sm" mt={4}>
            Designed and built the entire web architecture — frontend to backend
            — to help a wellness startup grow its online presence and enable
        ...
        <Timeline.Item title="Full Stack Developer – Royal Brothers">
          ...
          <Text size="sm" mt={4}>
            Modernized the website UI with a strong focus on customer experience
            and SEO optimization. Contributed across the stack to improve site
        ...
        <Timeline.Item title="Frontend Intern – Royal Brothers">
          ...
          <Text size="sm" mt={4}>
            Upgraded existing UI components and assisted in migrating legacy
            code to a more maintainable design structure.
          </Text>
        </Timeline.Item>
      </Timeline>
    </Container>
