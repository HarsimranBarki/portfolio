...
import { Button, Container, Notification, Stack, TextInput, Textarea } from '@mantine/core';
  ...
  return (
    <Container py="xl">
      <Stack gap={20}>
        ...
        {status === 'success' && (
          <Notification icon={<IconCheck size={16} />} color="teal" title="Message sent!" mt="md">
            Thanks! I’ll get back to you soon.
          </Notification>
        )}

        {status === 'error' && (
          <Notification icon={<IconX size={16} />} color="red" title="Error" mt="md">
            Something went wrong. Please try again later.
          </Notification>
        )}

        <ResponsiveText>
          If you’d like to connect, feel free to reach out — I’m always happy to collaborate 🤝, brainstorm ideas 💡, or
          just chat about tech 🧑‍💻 and life 🌱.
        </ResponsiveText>
      </Stack>
    </Container>
  );
